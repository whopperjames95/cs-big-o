...
// ANSWER: No, because if we were to simplify this function, we would then be micro optimizing, it may look prettier and shorter but in reality time will not be much different.
...
//   for (let i = 0; i < numbers.length; i++) {
//     answers.push(numbers[i] * numbers2[i])
//   }
//   return answers
// }
...
// ANSWER: Only have 1 loop in each function, also there are multiple characters(letters) in each function
// but a set amount, but the regex pattern is a lot more convenient.
